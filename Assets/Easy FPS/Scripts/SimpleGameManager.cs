...
public class SimpleGameManager : MonoBehaviour
{
    ...
    {
        win_text.text = "You " + q1Name + ", " + q2Name + ", and " + q3Name + "!";
    }
    ...
    {
        questStates.Add("Dummie1", false);
        questDescriptions.Add("Dummie", "Killed the red-haired brute holding an axe!");
        questStates.Add("Dummie2", false);
        questDescriptions.Add("Dummie2", "Smoked the little imp!");
        questStates.Add("Dummie3", false);
        questDescriptions.Add("Dummie", "Annihilated the alien trooper!");
        Debug.Log("Added Quests for Dummie1, Dummie2, and Dummie3");
    }
